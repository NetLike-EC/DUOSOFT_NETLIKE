...
<div class="row">
    ...
    <fieldset class="form-horizontal well well-sm">
        ...
        <div class="form-group">
        	<label class="control-label col-sm-3" for="resultado">Tipos</label>
			<div class="col-sm-9">
            <?php generarselect('typ_cod',detRowGSel('db_types','typ_cod','typ_val','typ_ref','TIPEXAM'),$detexam['typ_cod'],' form-control '); ?>
			</div>
		</div>
		<div class="form-group">
