...
<tbody>
	...
	$btnStat=fncStat('_fncts.php',array("id"=>$det_id, "val"=>$dRSd['men_stat'],"acc"=>'STM',"url"=>$_SESSION['urlc']));
	...
	?>
	  <tr class="<?php echo $css_tr ?>">
        ...
        <td><div class="btn-group">
          <a href="form_items.php?id=<?php echo $det_id ?>" class="btn btn-primary btn-xs fancybox.iframe fancyreload">
