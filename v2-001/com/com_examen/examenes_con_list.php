...
<div class="panel panel-primary">
  <div class="panel-heading">
    ...
    <a href="<?php echo $RAIZc ?>com_hc/examen_form.php?idp=<?php echo $idp ?>&idc=<?php echo $idc ?>&action=NEW" class="btn btn-default btn-xs fancybox.iframe fancyreload"> NUEVO <i class="fa fa-plus-circle fa-lg"></i> </a>
  </div>
...
?>
	...
	<tr <?php echo $classtr?>>
            ...
            <a href="<?php echo $RAIZc; ?>com_hc/examen_form.php?ide=<?php echo $row_RSe['id_exa'] ?>&action=DELEF" class="btn btn-default btn-danger btn-xs fancybox.iframe fancyclose"><i class="fa fa-trash-o"></i> Eliminar</a>
            </div>
            </td>
        </tr>
