...
if($detdoc){
	...
	$btnform='<button type="submit" class="btn btn-success"><i class="fa fa-floppy-o fa-lg"></i> ACTUALIZAR</button>';
	...
	$doc_nom=$detdocf['nombre'];
	$doc_con=$detdocf['formato'];
	$btnform='<button type="submit" class="btn btn-primary"><i class="fa fa-floppy-o fa-lg"></i> GUARDAR</button>';
}
...
<div class="row">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <label class="sr-only" for="nombre">Documento</label>
    ...
    <div class="panel panel-default">
        ...
        <?php echo genSelect("valSel[]",detRowGSel('db_diagnosticos','id_diag','nombre','estado','1'),detRowSel('db_documentos_diag_vs','id_diag','id_doc',$idd),'form-control', 'multiple', 'chosTyp',NULL,FALSE); ?>
        </div>
    </div>
