...
if($detTrat){
	...
	if($detTD){//Detalle Tratamiento
		$accTD='UPDD';
		$btnAccTD='<button class="btn btn-success btn-block" type="submit"><i class="fa fa-floppy-o fa-lg"></i> Actualizar Medicamento</button>';
	}else{
		$accTD='INSD';
		$btnAccTD='<button class="btn btn-primary btn-block" type="submit"><i class="fa fa-floppy-o fa-lg"></i> Agregar Medicamento</button>';
	}
