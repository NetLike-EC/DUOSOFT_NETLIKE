...
<div class="panel panel-primary">
  <div class="panel-heading">
    ...
    <a href="<?php echo $RAIZc ?>com_hc/tratamiento_form.php?idp=<?php echo $idp ?>&idc=<?php echo $idc ?>" class="btn btn-default btn-xs fancybox.iframe fancyreload"> <i class="fa fa-plus-circle fa-lg"></i> NUEVO </a>
