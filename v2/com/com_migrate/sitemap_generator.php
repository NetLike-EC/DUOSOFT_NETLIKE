...
/********************************************************************************************************/
//Sitemap Items
$query_RS = "SELECT item_id, item_aliasurl, cat_id, item_lastupdate FROM tbl_items WHERE item_status = 1 ORDER BY item_id DESC";
$RS = mysql_query($query_RS) or die(mysql_error());
$dRS = mysql_fetch_assoc($RS);
$totalRows_RS = mysql_num_rows($RS);
...
$buffer.=returnchildxml($RAIZ0."new/",$datenow,$cf["m"],$pr[10]);//Contact Us
$TL++;
echo '<li>Clearance</li>';
$buffer.=returnchildxml($RAIZ0."clearance/",$datenow,$cf["m"],$pr[10]);//Contact Us
$TL++;
