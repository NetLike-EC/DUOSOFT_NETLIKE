...
include(RAIZs.'conn/conn_komiko.php');
include(RAIZf.'_head.php');?>
<?php //BEGIN ARGO
mysql_select_db($db_conn_komiko, $conn_komiko);
...
WHERE frames.habilitado=1 ORDER BY frames.categoria');
$RSSia=mysql_query($qryMim,$conn_komiko);
$dRSSia=mysql_fetch_assoc($RSSia);
?>
<body class="cero">
<div class="container">
<h2>MIGRATE KOMIKO --> MERCOFRAMES</h2>
