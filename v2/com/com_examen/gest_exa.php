...
<?php if($detPac){
$qry=sprintf('SELECT * FROM db_examenes WHERE cli_id=%s ORDER BY id_exa DESC',
SSQL($id,'int'));
$RSh=mysql_query($qry);
	...
	<div>
	  <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
            <a class="btn btn-info btn-xs fancyreload fancybox.iframe" href="<?php echo $RAIZc ?>com_hc/examen_form.php?ide=<?php echo $row_RSh['id_exa'];?>">
        	<i class="fa fa-edit fa-lg"></i> Editar</a>
            <a href="actions.php?ide=<?php echo $row_RSh['id_exa'] ?>&acc=DEL" class="btn btn-danger btn-xs">
