...
<tbody>
	...
	?>
	  <tr>
        ...
        <td align="center"><?php echo $messFrom?></td>
		<td align="center"><a href="mess_data.php?id=<?php echo $messId?>" rel="shadowbox[view];options={relOnClose:true}" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-eye-open"></span></a></td>
		</tr>
	  <?php
