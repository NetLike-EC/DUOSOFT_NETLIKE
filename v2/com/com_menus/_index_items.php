...
if($TR>0){
	...
	$query_RSd = sprintf('SELECT * FROM  tbl_menus_items WHERE 1=1 %s ORDER BY men_padre ASC, men_id ASC, men_orden ASC '.$pages->limit,
	SSQL($param['idmc']['q'],''));
...
<div class="container">
	<div class="btn-group pull-right">
       	<a href="index.php" class="btn btn-default"><span class="fa fa-eye"></span> Gestionar Contenedores</a>
    	<a href="form_items.php" class="btn btn-primary fancybox.iframe fancyreload"><span class="fa fa-plus fa-lg"></span> Nuevo</a>
    </div>
	...
	<div class="well well-sm">
		<form class="form-inline">
			...
			<div class="form-group">
				...
				<?php genSelect('idmc', detRowGSel('tbl_menus','id','CONCAT(sec," | ",nom)','stat','1'), $param['idmc'], 'form-control input-sm', NULL, NULL, NULL, TRUE, NULL, "- Select -")?>
			</div>
...
<tbody>
	...
	$btnStat=fncStat('fncts.php',array("id"=>$id, "val"=>$dRSd['men_stat'],"acc"=>md5('STmi'),"url"=>$_SESSION['urlc']));
	?>
	  <tr class="<?php echo $css_tr ?>">
        <td><?php echo $id ?></td>
		<td><?php echo $btnStat ?></td>
        <td><span class="label label-default"><?php echo $detMC['sec'] ?></span> <span class="label label-info"><?php echo $detMC['nom'] ?></span></td>
        ...
        <td><div class="btn-group">
          <a href="form_items.php?ids=<?php echo $ids ?>" class="btn btn-primary btn-xs fancybox.iframe fancyreload">
            <i class="fa fa-edit"></i> Edit</a>
          <a href="fncts.php?ids=<?php echo $ids ?>&acc=<?php echo md5('DELmi') ?>" class="btn btn-danger btn-xs fancybox.iframe fancyreload">
...
<?php }else{ echo '<div class="alert alert-info"><h4>Sin registros!</h4></div>'; } ?>
</div>
</html>