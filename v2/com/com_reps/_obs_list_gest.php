...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">REPORTES OBSTETRICOS</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <a href="<?php echo $RAIZc ?>com_reps/obs_form.php?idp=<?php echo $id ?>" class="btn btn-info fancybox.iframe fancyreload"><col-md- class="glyphicon glyphicon-plus-sign"></col-md-> NUEVO</a>
      </div>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
<div>
    ...
    <tbody>
	<?php do{ ?>
	<?php $detP=detRow('db_clientes','cli_id',$row_RSr['cli_id']); ?>
	<tr <?php echo $classtr?>>
