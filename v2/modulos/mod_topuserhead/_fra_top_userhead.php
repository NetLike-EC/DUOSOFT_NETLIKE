...
$query_RS_user_detail = "SELECT * FROM tbl_usuario WHERE usr_nombre='".$emp_ses_username_RS_user_detail."'";
	...
	<td><!--Contenidos Head-->
		<table align="right">
        	<tr>
                ...
                <td align="left" class="text_sec_gray_min"><strong><?php echo $datausr['usr_nombre']; ?></strong></td>
			</tr>
            <tr>
