...
function fnc_ins_per($data){
	$detPer=detRow('tbl_personas','per_doc',$data['form_doc']);
	if($detPer){
    	...
    	GetSQLValueString($data['form_nom'], "text"),
		GetSQLValueString($data['form_ape'], "text"),
		GetSQLValueString($data['form_mail'], "text"),
		GetSQLValueString($data['form_dir'], "text"),
		GetSQLValueString($data['form_ciu'], "text"),
		GetSQLValueString($data['form_tel'], "text"),
		GetSQLValueString($data['form_cel'], "text"),
		GetSQLValueString($data['form_naci'], "date"),			
		GetSQLValueString($data['form_cont_nom'], "text"),
		GetSQLValueString($data['form_cont_tel'], "text"),
		GetSQLValueString($data['form_cont_dir'], "text"),
		GetSQLValueString($data['form_cont_mail'], "text"),
		...
		GetSQLValueString($data['form_doc'], "text"),
    	GetSQLValueString($data['form_nom'], "text"),
		GetSQLValueString($data['form_ape'], "text"),
		GetSQLValueString($data['form_mail'], "text"),
		GetSQLValueString($data['form_dir'], "text"),
