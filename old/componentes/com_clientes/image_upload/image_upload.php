        ...
        if(window.uploadedImage.document.body.innerHTML == loadingHtml) {
          if(maxLoadingTime <= 0) {
            divResult.innerHTML = "The image loading has timed up. "
                                + "Por favor , try again when the image is loaded.";
          }
          else {
            divResult.innerHTML = imageLoadingHtml;
...
<div id="imagecapture_container">
	...
	<div id="capture_result" class="capture_cont">
        <iframe id="uploadedImage" name="uploadedImage" src="" style="width:320px; height:290px" frameborder="0" marginheight="0" marginwidth="0" scrolling="auto"></iframe>
    </div>
</div>