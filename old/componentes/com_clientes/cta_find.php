...
$().ready(function() {
	...
	$("#singleBirdRemote").autocomplete("search_cli.php?idsearch="+id_tip, {
			width: 300,
			selectFirst: false
	});
...
<tr>
	<td>
		<form autocomplete="off">
            ...
            <option value="find_nom" selected="selected">Nombre Paciente</option>
	...
	<img src="<?php echo $RAIZ ?>images/struct/loading.gif" alt="Loading..." width="32" height="32" /></div></td>
  </tr>
</table>
<table align="center">
    <tr>
