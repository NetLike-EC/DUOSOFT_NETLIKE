...
{
	$queryins='INSERT INTO tbl_empleados(emp_ced,emp_nom,emp_ape,emp_dir,emp_tel1,emp_tel2,typ_cod,emp_img) VALUES("'.$_POST['txt_ced_emp'].'","'.$_POST['txt_nom_emp'].'","'.$_POST['txt_ape_emp'].'","'.$_POST['txt_dir_emp'].'","'.$_POST['txt_tel1_emp'].'","'.$_POST['txt_tel2_emp'].'","'.$_POST['txt_tip_emp'].'"'.$valueimageemp_ins[2].')';
...
{
	$queryupd='UPDATE tbl_empleados SET emp_nom="'.$_POST['txt_nom_emp'].'", emp_ape="'.$_POST['txt_ape_emp'].'", emp_ced="'.$_POST['txt_ced_emp'].'", emp_dir="'.$_POST['txt_dir_emp'].'", emp_tel1="'.$_POST['txt_tel1_emp'].'", emp_tel2="'.$_POST['txt_tel2_emp'].'", typ_cod="'.$_POST['txt_tip_emp'].'"'.$valueimageemp_upd.' WHERE emp_cod="'.$_POST['txt_cod_emp'].'"';	
