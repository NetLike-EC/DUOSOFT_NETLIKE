<?php
$query_RS_list_comp = "SELECT * FROM tbl_compra_cab WHERE com_stat='1' ORDER BY com_num DESC";
...
$query_RS_list_compA = "SELECT * FROM tbl_compra_cab WHERE com_stat='0' ORDER BY com_num DESC";
