...
if($_SESSION['stat_proc']=='PROCESS'){
	$prov_id = $_POST['prov_id'];//Proveedor a Grabar
	$com_tip=$_POST['com_tip'];//Tipo de Pago
	$com_proc=$_POST['com_proc'];//Procedencia
	$com_imp=$_POST['com_imp'];//Impuestos
