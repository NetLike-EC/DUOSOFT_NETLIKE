...
<form id="form_compra_cab" name="form_compra_cab" method="post" action="fnc_agregar_e.php">
...
<div class="portlet box blue" style="margin-bottom:0px;">
	...
	<div class="row-fluid">
		<div class="span6">
		<h4>Egreso de Mercaderia - SIN FACTURA</h4></div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php 
				 ...
				 <div class="btn"><strong><?php echo $detPer_name;?></strong></div>
			</div>
			</div>
		</fieldset>
		</div>
